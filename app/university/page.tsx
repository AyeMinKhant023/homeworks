                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <div className="flex-1">
                    <div>
                      ...
                      <hr className="my-3" />
                      <p className="text-gray-600 mb-2">{university.rank}</p>
...
//                     <button className={`${btnStyle} py-4 px-5 rounded-full`}>
//                       Search
//                     </button>
//                   </div>
//                 </div>
...
//                               }}
//                               className={`${adminBtnStyle}`}
//                               //w-full bg-blue-500 text-white py-3 rounded-full hover:bg-blue-600 transition-colors
//                             >
//                               Edit
//                             </Link>
//                             <DeleteButton
...
//               Here you can add more detailed content that will start with a
//               white background after the hero section. This part of the page
//               will scroll normally. You can add as much content here as needed
//               to provide more information about your services or insights.
//             </p>
//           </div> */}
//         </div>
//       </div>
